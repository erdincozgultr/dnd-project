...
const getCRColor = (cr) => {
  ...
  if (crStr.includes("/") || parseFloat(cr) <= 1)
    return { bg: "bg-green-500", text: "text-green-700", light: "bg-green-50" };
  if (parseFloat(cr) <= 4)
    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-br from-red-50 to-red-100 border border-red-200 rounded-2xl overflow-hidden">
        <div className="flex items-center justify-between px-4 py-2 bg-black/5">
          ...
          <span
            className={`px-2 py-0.5 ${crColor.bg} text-white rounded text-xs font-bold`}
          >
        ...
        <div className="p-4">
          ...
          <div className="grid grid-cols-3 gap-3">
            <div className="bg-white/80 rounded-lg p-3 text-center">
              ...
              {data.armor_desc && (
                <p className="text-[9px] text-sti">({data.armor_desc})</p>
              )}
            </div>
            ...
            <div className="bg-white/80 rounded-lg p-3 text-center">
              ...
              {data.hit_dice && (
                <p className="text-[9px] text-sti">({data.hit_dice})</p>
              )}
            </div>
