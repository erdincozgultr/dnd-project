...
const LeaderboardSection = () => {
  ...
  useEffect(() => {
    sendRequest({
      ...
      params: { limit: 5 },
      callbackSuccess: (res) =>
        setData((prev) => ({ ...prev, topUsers: res.data })),
    ...
    sendRequest({
      ...
      params: { limit: 5 },
      callbackSuccess: (res) =>
        setData((prev) => ({ ...prev, topHomebrews: res.data })),
      showErrorToast: false,
    });
    ...
    sendRequest({
      ...
      params: { limit: 5 },
      callbackSuccess: (res) =>
        setData((prev) => ({ ...prev, topGuilds: res.data })),
      showErrorToast: false,
    });
  }, []);
  ...
  const getRankStyle = (rank) => {
    if (rank === 1)
      return "bg-gradient-to-r from-yellow-500 to-amber-400 text-white shadow-lg shadow-yellow-500/30";
    if (rank === 2)
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-white/60 max-w-xl mx-auto">
            En başarılı maceracılar, en beğenilen eserler ve en güçlü loncalar
            burada!
          </p>
        </div>
                    ...
                    data.topUsers.map((entry, index) => (
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          <UserHoverCard username={entry.user?.username}>
                            <span className="text-white font-bold hover:text-cta transition-colors truncate block cursor-pointer">
                        ...
                        <div className="text-right flex-shrink-0">
                          <p className="text-cta font-black text-xl">
                        ...
                        <ChevronRight
                          size={20}
                          className="text-white/30 group-hover:text-cta group-hover:translate-x-1 transition-all flex-shrink-0"
                        />
                      </Link>
                    ))
                  )}
