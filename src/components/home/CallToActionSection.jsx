        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="flex flex-col gap-6">
            ...
            <p className="text-lg text-sti leading-relaxed italic border-l-4 border-cbg pl-6">
              "Kule'nin kapıları sadece cesurlara açılır. Bu anlaşma ile
              zarların kaderine ortak olmayı ve topluluğun bir parçası olmayı
              kabul edersin."
            </p>

            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 my-4">
              <ContractFeature text="İçerik Oluşturma / Yorumlama Hakkı" />
              <ContractFeature text="Parti Kurma / Katılma Yetkisi" />
              <ContractFeature text="Özel Profil Rozetleri" />
              <ContractFeature text="Lonca Kurma / Katılma Hakkı" />
              <ContractFeature text="İçeriklerden Koleksiyon Oluşturma Hakkı" />
            </div>
            ...
            <p className="text-xs text-sti/50 flex items-center gap-1">
              <Lock size={12} /> Bilgileriniz şifreli bir parşömende
              korunmaktadır.
            </p>
          </div>
        </div>
...
const ContractFeature = ({ text }) => (
  <div className="flex items-center gap-3">
    ...
    <span className="text-mtf font-bold text-sm uppercase tracking-tight">
      {text}
    </span>
  </div>
);
