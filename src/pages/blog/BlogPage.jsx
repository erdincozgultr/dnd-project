...
import { BookOpen, Search, Filter, Loader } from 'lucide-react';
        ...
        <div className="bg-gradient-to-br from-purple-900 via-red-900 to-purple-900 text-white py-16">
          <div className="max-w-7xl mx-auto px-4">
            ...
            <p className="text-xl text-white/80 max-w-2xl">
              D&D maceralarınızı paylaşın, deneyimlerinizden öğrenin. 
              Rehberler, senaryolar ve kampanya günlükleri.
            </p>
          </div>
        </div>
              ...
              <div className="mt-3 flex items-center gap-2 text-sm text-sti">
                ...
                {selectedCategory && (
                  <span className="px-2 py-1 bg-purple-100 text-purple-700 rounded-lg">
                    {getCategoryOptions().find(c => c.value === selectedCategory)?.label}
                  </span>
                )}
                {searchQuery && (
